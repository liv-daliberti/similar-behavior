...
ALPHAS_LIST=(0 0.1 0.3 0.4 0.5 0.6)

# Define for each alpha the corresponding seeds.
declare -A ALPHA_SEEDS
ALPHA_SEEDS[0]="1 4 5"
ALPHA_SEEDS[0.1]="1 4 5"
ALPHA_SEEDS[0.3]="4 5"
ALPHA_SEEDS[0.4]="1 4 5"
ALPHA_SEEDS[0.5]="1 4 5"
ALPHA_SEEDS[0.6]="1 4 5"

counter=0

# Loop over each alpha and its corresponding seeds.
