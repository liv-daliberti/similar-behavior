        ...
        if global_step > args.learning_starts:
            ...
            if global_step % 50000 == 0:
                checkpoint = {
                    ...
                    # Optionally include other states such as wandb logs or scheduler state if needed.
                    'args': vars(args)  # Save current hyperparameters for reproducibility.
                }
                
                # Define the checkpoint path inside the "files" folder of the current wandb run directory.
